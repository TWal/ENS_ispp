...
% mot clés en environement mathématique (et et ou sont des opérateur de logique contrairement aux autres) :
...
\newcommand{\lin}{\qopname\relax o{\mathscr{L}\!}}%ensemble des applications linéaire
